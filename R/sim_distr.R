...
#' @param distr the distribution to be used. This must be one of "normal", "exponential", "poisson" or "weibull".
#' @param ... arguments specific to each distribution. See \code{\link[stats:rnorm]{rnorm}}, \code{\link[stats:rexp]{rexp}}, \code{\link[stats:rpois]{rpois}}, \code{\link[stats:rweibull]{rweibull}} to know these arguments.
#'
#' @return
...
#' @examples
#'
#' @seealso \code{\link[stats:rexp]{rexp}},
#' \code{\link[stats:rnorm]{rnorm}},
