...
empire is an R package that provides a set of functions to handle missing values, since intransitive imputation `impute_mean`, `impute_median`), to transitive imputation (`estimate_mlr`) applying Ridge penalization (`estimate_ridge`).
